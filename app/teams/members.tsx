...
export default function Members() {
    ...
    const searchAthletes = async (name: string) => {
        try {
            setSearching(true);
            const res = await fetch(`https://server.riyadah.app/api/users/search?keyword=${name}&type=Athlete`);
    ...
    const handleAddMember = async (athlete: any) => {
        ...
        try {
            ...
            const res = await fetch(`https://server.riyadah.app/api/teams/${team._id}/members`, {
                method: 'PUT',
                headers: {
